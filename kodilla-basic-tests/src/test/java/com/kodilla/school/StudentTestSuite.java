...
public class StudentTestSuite {
    ...
    @Test
    public void shouldCalculateCorrectAverangesIfValuesAreInRange() {
        ...
        double geographyAverange = student.getGeographyAverage();
        ...
        assertEquals(3.33, geographyAverange, 0.01);
        assertEquals(3, historyAverage, 0.01);
        assertEquals(0, mathsAverage, 0.01);
        assertEquals(0, physicsAverage);
    }
