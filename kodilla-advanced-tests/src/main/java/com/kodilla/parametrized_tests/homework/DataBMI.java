...
//        return Stream.of(
//                Arguments.of(new Person(1.60, 43.0, "Very severely underweight")),
//                Arguments.of(new Person(1.65, 47.0, "Severely underweight")),
//                Arguments.of(new Person(1.70,56.5, "Underweight")),
//                Arguments.of(new Person(1.75,68.0, "Normal (healthy weight)"))
